  ...
  <body>
              ...
              <table class="table table-sm fs--1 mb-0">
                <thead>
                  <tr>
                    ...
                    <th style="min-width: 80px;" class="sort align-middle">BIO ID</th>
                    <th style="min-width: 120px;" class="sort align-middle">EMPLOYEE ID</th>
                    <th class="sort align-middle" scope="col" data-sort="customer" style="width:15%; min-width:180px;">NAME</th>
                    <th class="sort align-middle" scope="col" data-sort="email" style="width:15%; min-width:180px;">EMAIL</th>
                    <th class="sort align-middle pe-3" scope="col" data-sort="mobile_number" style="width:20%; min-width:150px;">MOBILE NUMBER</th>
                    <th class="sort align-middle text-end pe-0" scope="col" data-sort="joined" style="width:19%;  min-width:150px;">DATE OF JOINING</th>
                    <th class="sort align-middle text-end" scope="col" data-sort="last_active" style="width:21%;  min-width:150px;">ACTION</th>
                  </tr>
                </thead>
                <tbody class="list" id="members-table-body">
                  <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="customer align-middle white-space-nowrap">1</td>
                    <td class="customer align-middle white-space-nowrap">143</td>
                    <!-- <td class="customer align-middle white-space-nowrap">dhatchu</td> -->
                    <td class="customer align-middle white-space-nowrap">
    <a class="d-flex align-items-center text-900 text-hover-1000" href="#!" onclick="toggleCollapse()">
    ...
    <div class="collapse mt-2" id="collapseExample">
            <div class="border p-3 rounded">
                ...
                <p><strong>Official Email:</strong> carry.anna@company.com</p>
                <p><strong>LinkedIn:</strong> <a href="https://www.linkedin.com/in/carryanna" target="_blank">Carry Anna</a></p>
                <p><strong>Portfolio:</strong> <a href="https://www.carryanna.com" target="_blank">www.carryanna.com</a></p>
            </div>
        </div>
</td>
    ...
    function toggleCollapse() {
        ...
        if (collapseDiv.classList.contains('show')) {
            ...
            collapseDiv.classList.add('show');
                    ...
                    <td class="mobile_number align-middle white-space-nowrap"><a class="fw-bold text-1100" href="tel:+912346578">+91 9876543210</a></td>
