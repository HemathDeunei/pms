<li class="nav-item">
                            ...
                            <div class="nav-item-wrapper"><a class="nav-link label-1" href="{{route('student_list')}}"
                                    role="button" data-bs-toggle="" aria-expanded="false">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                data-feather="users"></span></span><span
                                            class="nav-link-text-wrapper"><span
                                                class="nav-link-text">Student List</span></span></div>
                                </a></div>
                                ...
                                <div class="parent-wrapper label-1">
                                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse"
                                        ...
                                        <li class="nav-item"><a class="nav-link"
                                                ...
                                                aria-expanded="false">
                                                <div class="d-flex align-items-center"><span
                          i                            class="nav-link-text">Progress bar</span></div>
                                            </a><!-- more inner pages-->
                                        </li>
                                        <li class="nav-item"><a class="nav-link"
