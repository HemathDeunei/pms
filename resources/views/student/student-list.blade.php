      ...
      <div id="members"
        ...
        <div class="row align-items-center justify-content-between g-3 mb-4">
          ...
          <div class="col-auto">
            <div class="d-flex align-items-center"><button class="btn btn-link text-900 me-4 px-0"><span
                  ...
                  class="fas fa-plus me-2"></span>Add Student</button></div>
          </div>
        </div>
              ...
              <thead>
                <tr>
                  <th class="white-space-nowrap fs--1 align-middle ps-0">
                    <div class="form-check mb-0 fs-0"><input class="form-check-input" id="checkbox-bulk-members-select"
                        type="checkbox" data-bulk-select='{"body":"members-table-body"}' /></div>
                  </th>

                  <th class="sort white-space-nowrap align-middle ps-0" scope="col" data-sort="regNo"
                    style="width:15%;">REG NO</th>
                  <th class="sort align-middle ps-3" scope="col" data-sort="name" style="width:20%;">NAME</th>
                  <th class="sort align-middle ps-3" scope="col" data-sort="department" style="width:15%;">DEPARTMENT
                  </th>
                  <th class="sort align-middle ps-3" scope="col" data-sort="email" style="width:20%;">EMAIL</th>
                  <th class="sort align-middle ps-3" scope="col" data-sort="mobileNumber" style="width:15%;">MOBILE
                    NUMBER</th>
                  <th class="sort align-middle ps-3" scope="col" data-sort="batchYear" style="width:15%;">BATCH/YEAR
                  </th>
                  <th class="sort align-middle ps-3" scope="col" data-sort="actions" style="width:15%;">ACTIONS</th>
                </tr>
              </thead>
        ...
        <script>
          $(document).ready(function () {
            ...
            $.ajax({
              type: "GET",
              url: "/fetch_students", // Replace with your endpoint URL
              dataType: "json",
              success: function (response) {
                ...
                if (response.students && response.students.length) {
                  // Loop through each student and generate table row
                  response.students.forEach(function (students) {
                    var row = `
                            <tr>
                                <td></td>
                                ...
                                <td>${students.student_mobile}</td>
                                <td>${students.batch_year}</td>
                  ...
                  // Handle empty response or no students
                  console.log("No students found in response.");
                }
              },
              error: function (xhr, status, error) {
                // Log error message if AJAX request fails
            ...
            $(document).on('click', '.accept-btn', function (e) {
              ...
              var token = "{{ csrf_token() }}"; // Get registration number from data attribute
