...
<head>
    ...
    <style>
        .fixed-width-1 { width: 50px; }
        .fixed-width-2 { width: 100px; }
        .fixed-width-3 { width: 150px; }
        .fixed-width-4 { width: 200px; }
    </style>
    <script>
      ...
      <div class="content">
        ...
        <div id="members" data-list='{"valueNames":["customer","email","mobile_number","city","last_active","joined"],"page":10,"pagination":true}'>
          <div class="row align-items-center justify-content-between g-3 mb-4">
            ...
            <div class="col-auto">
              <div class="d-flex align-items-center"><button class="btn btn-link text-900 me-4 px-0"><span class="fa-solid fa-file-export fs--1 me-2"></span>Export</button><button class="btn btn-primary"><span class="fas fa-plus me-2"></span>Add Student</button></div>
            </div>
          </div>
          <div class="mx-n4 mx-lg-n6 px-4 px-lg-6 mb-9 bg-white border-y border-300 mt-2 position-relative top-1">
            ...
            <tr>
                ...
                <th class="fixed-width-2">Reg no</th>
                <th class="fixed-width-3">Name</th>
                <th class="fixed-width-4">Department</th>
                <th class="fixed-width-4">Email</th>
                <th class="fixed-width-2">Mobile Number</th>
                <th class="fixed-width-3">Batch/Year</th>
                <th class="fixed-width-1">Actions</th>
            </tr>
        </thead>
                  </tr>
                </thead>
                <tbody class="list" id="members-table-body">
                  <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="customer align-middle white-space-nowrap">BSC CS</td>
                    ...
                    <td class="customer align-middle white-space-nowrap">5/3Y</td>
