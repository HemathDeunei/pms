...
<body>
                                        ...
                                        <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-split"
                                            ...
                                            <div class="parent-wrapper">
                                                <ul class="nav collapse parent" data-bs-parent="#authentication"
                                                    ...
                                                    <li class="nav-item"><a class="nav-link"
                                                            href="pages/authentication/split/2FA.html" data-bs-toggle=""
                                                            aria-expanded="false">
                                                            <div class="d-flex align-items-center"><span
                                                                    class="nav-link-text">2FA</span><span
                                                                    class="badge ms-2 badge badge-phoenix badge-phoenix-info ">New</span>
                                        ...
                                        <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-Card"
                                            ...
                                            <div class="parent-wrapper">
                                                <ul class="nav collapse parent" data-bs-parent="#authentication"
                                                    ...
                                                    <li class="nav-item"><a class="nav-link"
                                                            href="pages/authentication/card/2FA.html" data-bs-toggle=""
                                                            aria-expanded="false">
                                                            <div class="d-flex align-items-center"><span
                                                                    class="nav-link-text">2FA</span><span
                                                                    class="badge ms-2 badge badge-phoenix badge-phoenix-info ">New</span>
                                ...
                                <div class="parent-wrapper label-1">
                                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse"
                                        ...
                                        <li class="nav-item"><a class="nav-link"
                                                ...
                                                aria-expanded="false">
                                                <div class="d-flex align-items-center"><span
                                                        class="nav-link-text">Candlestick charts</span>
                                                </div>
                                            </a><!-- more inner pages-->
                                        </li>
                            ...
                            <div class="card position-relative border-0">
                                ...
                                <div class="card-footer p-0 border-top">
                                    ...
                                    <div class="my-2 text-center fw-bold fs--2 text-600"><a class="text-600 me-1"
                                            ...
                                            class="text-600 ms-1" href="#!">Cookies</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="row gx-4 gy-5">
                                            <div class="col-12 col-sm-6 col-md-4">
                                                ...
                                                <div class="dropdown-item-group mt-5"><span class="me-2"
                                                    ...
                                                    charts</a><a class="dropdown-link"
                                                    href="modules/echarts/how-to-use.html">How to
                                                    use</a>
                                            </div>
                                            <div class="col-12 col-sm-6 col-md-4">
                                                <div class="dropdown-item-group"><span class="me-2"
    ...
    $.ajax({
        type: "GET",
        url: "/admin/fetch-developers", // Adjust the URL as per your route
        dataType: "json",
        success: function (response) {
            var developerList = $('#developer-list');
            developerList.html('');
            $.each(response, function (key, developer) {
                var row = '<tr>' +
                    '<td>' + developer.bio_id + '</td>' +
                    '<td>' + developer.user_name + '</td>' +
                    '<td>' + developer.personal_email + '</td>' +
                    '<td>' + developer.office_email + '</td>' +
                    '<td>' + developer.emp_id + '</td>' +
                    '<td>' + developer.tech_stack + '</td>' +
    ...
    function acceptDeveloper(email, name) {
        $.ajax({
            type: "POST",
            url: "/accept_developer",
            data: {
                email: email,
                name: name,
            ...
            success: function (response) {
                console.log("Developer accepted and stored successfully");
            },
            error: function (xhr, status, error) {
                console.error(xhr.responseText);
            }
    ...
    function rejectDeveloper(email) {
        $.ajax({
            type: "POST",
            url: "/reject_developer",
            data: { email: email },
            success: function (response) {
    ...
    $(document).on("click", ".accept-btn", function () {
        ...
        acceptDeveloper(email, name);
    });

    $(document).on("click", ".reject-btn", function () {
        var email = $(this).data("email");
        rejectDeveloper(email);
    });
});
                    ...
                    <div class="col-6"><input class="btn-check" id="navbarPositionTopDouble" name="navigation-type"
                            ...
                            class="btn d-inline-block btn-navbar-style fs--1" for="navbarPositionTopDouble"> <span
                                class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none"
                                    ...
                                    alt="" /></span><span class="label-text"> Dual
                                nav</span></label></div>
                </div>
            </div>
            <div class="setting-panel-item">
