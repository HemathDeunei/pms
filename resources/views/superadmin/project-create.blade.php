...
<head>
  ...
  <script src="../../template/template/vendors/imagesloaded/imagesloaded.pkgd.min.js"></script>
...
<body>
  ...
  <main class="main" id="top">
              ...
              <div class="list pb-3">
                ...
                <div class="py-2"><a class="dropdown-item py-2 d-flex align-items-center"
                    ...
                    <div class="file-thumbnail me-2"><img class="h-100 w-100 fit-cover rounded-3"
                        src="../../template/assets/img/products/60x60/3.png" alt="" /></div>
                    <div class="flex-1">
                  ...
                  <a class="dropdown-item py-2 d-flex align-items-center"
                    ...
                    <div class="file-thumbnail me-2"><img class="img-fluid"
                        src="../../assets/template/img/products/60x60/3.png" alt="" /></div>
                    <div class="flex-1">
          ...
          <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button"
            ...
            <ul class="dropdown-menu navbar-dropdown-caret">
              ...
              <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="project-management" href="#"
                ...
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item active" href="create-new.html">
    ...
    <div class="content">
      ...
      <div class="row">
        <div class="col-xl-9">
          <form class="row g-3 mb-6" method="post" action="{{ route('project_store') }}" id="projectForm">
            @csrf
            <div class="col-sm-6 col-md-12">
              <div class="form-floating">
                <input class="form-control" id="title" type="text" placeholder="Project title" name="project_title" />
                <label for="title">Project title</label>
              </div>
            </div>
            <div class="col-sm-6 col-md-12">
              <div class="form-floating">
                <input class="form-control" id="source" type="text" placeholder="Source" name="project_source" />
            ...
            <div class="col-12 gy-3">
              <div class="form-floating">
                <textarea class="form-control" id="description" placeholder="Leave a comment here"
                  style="height: 224px;" name="project_description"></textarea>
            ...
            <div class="col-12 gy-6">
              <div class="row g-3 justify-content-end">
                ...
                <div class="col-auto"><button type="submit" class="btn btn-primary px-5 px-sm-15">Create
                    Project</button></div>
              </div>
            </div>
          </form>
            ...
            $.ajax({
              ...
              success: function (response) {
                ...
                if (response && response.success) {
                  ...
                  alert('Error: ' + (response.message || 'Unable to add project')); // Display error message
                }
              },
