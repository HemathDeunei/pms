              ...
              <div class="scrollbar-overlay" style="max-height: 30rem;">
                <div class="list pb-3">
                  ...
                  <div class="py-2"><a class="dropdown-item py-2 d-flex align-items-center" href="../e-commerce/landing/product-details.html">
                      <div class="file-thumbnail me-2"><img class="h-100 w-100 fit-cover rounded-3" src="../../template/assets/img/products/60x60/3.png" alt="" /></div>
                      <div class="flex-1">
                    ...
                    <a class="dropdown-item py-2 d-flex align-items-center" href="../e-commerce/landing/product-details.html">
                      <div class="file-thumbnail me-2"><img class="img-fluid" src="../../assets/template/img/products/60x60/3.png" alt="" /></div>
                      <div class="flex-1">
        ...
        <div class="row">
          <div class="col-xl-9">
            <form class="row g-3 mb-6">
              ...
              <div class="col-sm-6 col-md-12">
                <div class="form-floating"><input class="form-control" id="floatingInputGrid" type="text" placeholder="Source" /><label for="floatingInputGrid">Source</label></div>
              </div>
